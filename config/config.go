...
//Layout ...
type Layout struct {
	DefaultSpec    browser.Spec                       `yaml:"spec" json:"spec"`
	Meta           browser.Meta                       `yaml:"meta" json:"meta"`
	Path           string                             `yaml:"path" json:"path"`
	DefaultVersion string                             `yaml:"defaultVersion" json:"defaultVersion"`
	Versions       map[string]*browser.SpecForBrowser `yaml:"versions" json:"versions"`
}
...
func (cfg *BrowsersConfig) Find(name, version string) (*browser.SpecForBrowser, error) {
	cfg.lock.Lock()
	defer cfg.lock.Unlock()
